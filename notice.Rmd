...
<script>
   $(document).ready(function() {
     $head = $('#header');
     $head.prepend('<img src=\"MasterEsa.jpg\" style=\"float: right;width: 400px;\"/>')
   });
</script>
...
![Data presentation](onglet1.png)

&nbsp;

<p style="text-align:justify";>First, you have the dimension of the dataset. So we have 316295 observations and all the 26 the variables (the output & 25 explanatory variables).
Then, you can observe two histograms, which represent on the left the importance of the 25 independant variables, given by the information gain ; and on the right side, the result of a significant test is shown, based on the Khi-2 test.</p>
...
![Comparing of SVM with another Machine Learning model](onglet2.png)
...
Minsplit : represents the minimum number of observations in a node for a split to take place (5) </p>
Minbucket : says the minimum number of observations I should keep in terminal nodes (15) </p>
Cp : it's the complexity parameter (0.001) </p>

* for the Random Forest : </p>
Number of trees (157) </p>  
Node Size (12) </p>
Mtry (9) </p>

* for the Gradient Boosting : </p>
N trees (256) </p>
interaction depth (5) </p>
Min obs in node : refers to the minimum number of observations in a tree node (33) </p>  
shrinkage : it's the regulation parameter which dictates how fast / slow the algorithm should move  (0.24). </p>
...
Eta (0.278) </p>
Sub sample (0.56) </p>
Min child weight (4) </p>
Cold sample by tree (0.683) </p>
...
![Comparing model performance](onglet3.png)
