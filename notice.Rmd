...
![<strong>1<sup>st</sup> panel : Brief description of SVM and methodology</strong>](onglet0.png)
...
![<strong>2<sup>nd</sup> panel : Data presentation</strong>](onglet1.png)
...
![<strong>3<sup>rd</sup> panel : Comparing SVM with another Machine Learning model</strong>](onglet2.png)
...
![<strong>4<sup>th</sup> panel : Comparing model performance</strong>](onglet3.png)
